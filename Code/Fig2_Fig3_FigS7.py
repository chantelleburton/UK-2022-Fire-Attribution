# Plot PDFs for 2022 HadGEM3 ALL and NAT, plus ERA5 line
...
plt.title(Country+' '+str(percentile)+'th percentile FWI '+month+' 2022')
plt.ylabel('Density')
...
for Country in Countries:
    ...
    n = n+1
    '''
plt.suptitle(str(percentile)+'th percentile FWI '+month+' 2022')
